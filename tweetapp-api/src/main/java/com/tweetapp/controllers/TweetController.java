...
//	public String publishMessgae(@PathVariable String name)
//	{
//    	template.send("javatechie", "Hi "+name+" Welcome to Tweet App");
...
//
//		try {
//			return new ResponseEntity<>(kafkaTemplate.send("allTweets", "allTweets"), HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(new ErrorResponse("Application has faced an issue"),
//					HttpStatus.INTERNAL_SERVER_ERROR);
//		}
...
//			@RequestHeader(value = "loggedInUser") String loggedInUser) {
//		try {
//			return new ResponseEntity<>(kafkaTemplate.send("getUserTweets",username, loggedInUser), HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(new ErrorResponse("Application has faced an issue"),
//					HttpStatus.INTERNAL_SERVER_ERROR);
//		}
...
//		try {
//			return new ResponseEntity<>(
//					kafkaTemplate.send("updateTweet",tweetUpdate.getTweetId(), tweetUpdate.getTweetText()),
//					HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(new ErrorResponse("Application has faced an issue"),
//					HttpStatus.INTERNAL_SERVER_ERROR);
...
//	@DeleteMapping(value = "/tweets/{username}/delete")
//	public void deleteTweet(@PathVariable("username") String userId,
//			@RequestHeader(value = "tweetId") String tweetId){
//		System.out.println(tweetId);
//		kafkaTemplate.send("deleteTweet", tweetId);
//		
...
//			@RequestHeader(value = "tweetId") String tweetId) {
//		try {
//			return new ResponseEntity<>(kafkaTemplate.send("deleteTweet", tweetId), HttpStatus.OK);
//		} catch (Exception e) {
//			return new ResponseEntity<>(new ErrorResponse("Application has faced an issue"),
//					HttpStatus.INTERNAL_SERVER_ERROR);
//		}
